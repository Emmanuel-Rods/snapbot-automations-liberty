...
const Hero: React.FC = () => {
  return (
    <div className="section pt-28 sm:pt-32 md:pt-32 pb-16 md:pb-20 bg-gradient-to-b from-primary/5 to-white dark:from-primary/10 dark:to-secondary overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          <div className="text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              ...
              <Button variant="outline" className="btn btn-outline dark:text-white dark:border-white/30 dark:hover:border-primary">
                View Docs
              </Button>
            </div>
          </div>
          <div className="hidden lg:block relative">
            <div className="bg-white dark:bg-secondary-400/20 p-6 rounded-xl shadow-xl border border-gray-100 dark:border-gray-700 code-block">
